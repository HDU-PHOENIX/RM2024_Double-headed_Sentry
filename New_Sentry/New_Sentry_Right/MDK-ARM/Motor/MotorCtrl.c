...
PidTypeDef PID_VISION_YAW_ANGLE;
PidTypeDef PID_VISION_PITCH_ANGLE;


float PID_GIMBAL_3508_1_SPEED_K[3] = {7,0.5,1.5};//10,0.5,2
float PID_GIMBAL_3508_2_SPEED_K[3] = {7,0.5,1.5};//10,0.5,2
...
float PID_PITCH_4310_ANGLE_K[3] = {12.3,0.949999988,5.5};//30,0.01,20	
...
void Motor_Ctrl(void)
{
	...
	if((Gimbal_Data.IMUData.yaw_target > 0 && Gimbal_Data.IMUData.yaw_target < 1300) || (Gimbal_Data.IMUData.yaw_target > 7300 && Gimbal_Data.IMUData.yaw_target < 8192))
	{
	...
	pid_caculate(&PID_GIMBAL_6020_SPEED, yaw_speed, Motor_6020[0].speed_rpm_target);//	Motor_6020[0].speed_rpm_target//yaw轴电机速度环
	...
	float pitch_angle_target = Gimbal_Data.IMUData.pitch_target + 1.2853f;
	...
	{
		Motor_4310_send(&CAN_PITCH_4310,0x03,0,0,0,0,0);
	}
	else
	{
	  Motor_4310_send(&CAN_PITCH_4310,0x03,0,0,0,0,PID_PITCH_4310_SPEED.out);//PID_PITCH_4310_SPEED.out
	}
	Motor_4310_send(&CAN_PITCH_4310,0x03,0,0,0,0,PID_PITCH_4310_SPEED.out);//PID_PITCH_4310_SPEED.out
	

//	Motor_3508_send(&CAN_GIMBAL_3508_1, 0x200, PID_GIMBAL_3508_1_SPEED.out, PID_GIMBAL_3508_2_SPEED.out, PID_CHASSIS_3508_3_SPEED.out, PID_CHASSIS_3508_4_SPEED.out);
...
void Motor_PID_Init(void)
{
	...
	Motor_4310_start(&CAN_PITCH_4310, 0x03);
